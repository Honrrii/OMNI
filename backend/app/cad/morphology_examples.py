...
GOLDEN_EXAMPLES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "expected_family": "hybrid_biomorphic_drone",
        "expected_posture": "aerial",
        "expected_min_legs": 0,
        "must_have_hard_negatives": True,
    },
    ...
    {
        "name": "Manta-ray inspired drone",
        "mission": "Design a manta-ray-inspired drone for quiet indoor reconnaissance",
        "expected_family": "hybrid_biomorphic_drone",
        "expected_posture": "aerial",
        "expected_min_legs": 0,
        "must_have_hard_negatives": True,
    ...
    {
        "name": "Gecko-inspired rover",
        "mission": "Design a gecko-inspired rover for wall inspection",
        "expected_family": "biomorphic_rover",
        "expected_posture": "low_slung",
        "expected_min_legs": 0,
        "must_have_hard_negatives": True,
    },
    {
        "name": "Crab-inspired drone",
        "mission": "Design a crab-inspired drone with lateral landing legs",
        "expected_family": "hybrid_biomorphic_drone",
        "expected_posture": "aerial",
        "expected_min_legs": 0,
        "must_have_hard_negatives": True,
    ...
    {
        "name": "Snake-inspired rover",
        "mission": "Design a snake-inspired rover with a modular articulated body",
        "expected_family": "biomorphic_rover",
        "expected_posture": "low_slung",
        "expected_min_legs": 0,
        "must_have_hard_negatives": True,
    ...
    {
        "name": "Multi-trait biomorphic drone",
        "mission": "Design a drone with manta ray fins, dragonfly agility, and crab-like landing legs",
        "expected_family": "hybrid_biomorphic_drone",
        "expected_posture": "aerial",
        "expected_min_legs": 0,
        "must_have_hard_negatives": True,
    ...
    {
        "name": "Turtle-gecko hybrid rover",
        "mission": "Design a rover with turtle armor and gecko adhesive pads",
        "expected_family": "biomorphic_rover",
        "expected_posture": "low_slung",
        "expected_min_legs": 0,
        "must_have_hard_negatives": True,
